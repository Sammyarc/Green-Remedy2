...
const SimilarProducts = () => {
    ...
    return (
        <div className='m-[5vw]'>
            <h2 className='text-[6vw] md:text-[2.5vw] font-Lora font-bold text-textColor mb-[1vw]'>Similar Products</h2>
                            ...
                            >
                                ...
                                <div className="mt-[0.5vw] flex justify-center items-center gap-[0.2vw]">
                                    <div className="flex justify-center items-center gap-[0.4vw]">
                                        <AiFillStar className="transform transition-transform duration-300 text-[4vw] md:text-[1.3vw] text-rating" />
                                        <AiFillStar className="transform transition-transform duration-300 text-[4vw] md:text-[1.3vw] text-rating" />
                                        <AiFillStar className="transform transition-transform duration-300 text-[4vw] md:text-[1.3vw] text-rating" />
                                        <AiFillStar className="transform transition-transform duration-300 text-[4vw] md:text-[1.3vw] text-rating" />
                                        <AiOutlineStar className="transform transition-transform duration-300 text-[4vw] md:text-[1.3vw] text-rating" />
                                    </div>
