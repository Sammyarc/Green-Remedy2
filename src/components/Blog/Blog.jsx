        ...
        data-aos-delay="100">
        {
           blogItems.map((data) => (
                <div
                    ...
                    <img src={data.image} className="w-full h-[40vw] xs:h-[40vw] sm:h-[25vw] md:h-[18vw]" />
                    <h1 className='mt-[5vw] xs:mt-[4vw] sm:mt-[3vw] md:mt-[2.5vw] font-Lora font-semibold text-[5vw] xs:text-[3.5vw] sm:text-[2.5vw] md:text-[2vw] text-textColor'>
                        {data.heading}
                    </h1>
                    <p className='mt-[5vw] xs:mt-[4vw] sm:mt-[3vw] md:mt-[2.5vw] font-OpenSans text-[3.5vw] xs:text-[2.5vw] sm:text-[2vw] md:text-[1.2vw] text-textColor w-full md:w-[25vw]'>{data.paragraph}</p>
                    <div className='mt-[5vw] xs:mt-[4vw] sm:mt-[3vw] md:mt-[2.5vw] flex items-center justify-between'>
                        <a href='#' className='w-[25vw] xs:w-[25vw] sm:w-[15vw] md:w-[12.5vw] h-[8vw] xs:h-[8vw] sm:h-[5vw] md:h-[4.5vw] text-[3.5vw] xs:text-[2.5vw] sm:text-[2vw] md:text-[1.3vw] rounded-[3vw] xs:rounded-[2.5vw] sm:rounded-[2vw] md:rounded-xl bg-darkGreen flex items-center justify-center text-white'>{data.link}</a>
                        <p className='font-OpenSans text-textColor text-[3.5vw] xs:text-[2.5vw] sm:text-[2vw] md:text-[1.2vw]'>{data.read}</p>
                    </div>
                </div>
            ))
        }
             ...
             <div className='flex justify-center mt-[6vw] xs:mt-[5vw] sm:mt-[4vw] md:mt-[3vw]'>
    <a
        data-aos="zoom-in"
        data-aos-duration="500"
        data-aos-delay="200"
        ...
        <img src={RightArrow} alt='Arrow Icon' className='w-[5vw] xs:w-[4vw] sm:w-[3vw] md:w-[2vw]'/>
    </a>
</div>
