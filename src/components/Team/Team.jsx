...
const teamMembers = [
  {
    ...
    imageUrl: 'src/assets/Team/Indira Ramesh-Naik.png',
    linkedIn: 'https://linkedin.com/in/rameshindira',
  },
  {
    name: 'Olamide Ojo',
    role: 'Product Manager',
    imageUrl: 'src/assets/Team/Olamide Ojo.png',
