                ...
                <div className="flex justify-between items-center">
                    ...
                    <Link to="/">
                        <img
                            ...
                            className="xs:w-[27vw] md:w-[15vw] xs:h-[10vw]  md:h-[5vw]"/>
                    </Link>
                    ...
                    <div className="block">
                        <div className="relative">
                            <input
                                ...
                                className="search-input w-[40vw]  md:w-[32vw] h-[8vw] sm:h-[7vw] md:h-[3vw] border-2 border-lightTextColor rounded-full pl-[8vw] sm:px-[4vw] md:px-[3vw] text-[3vw] sm:text-[2vw] md:text-[1vw] outline-none font-OpenSans text-lightTextColor bg-transparent focus:border-darkGreen placeholder:text-[3vw] sm:placeholder:text-[2vw] md:placeholder:text-[1vw]"/>
                            <img
                                src={Search}
                                alt="Search Icon"
                    ...
                    <div className="hidden md:flex md:gap-[3vw] md:items-center">
                        {/* Signup/Account */}
                        {
                            isSignedIn
                                ? (
                                    <div
                                        className="relative md:flex md:gap-[0.5vw] md:items-center cursor-pointer font-OpenSans">
                                        <Link
                                            to="/account"
                                ...
                                ? (
                                    <div className="flex flex-row gap-2 items-center">
                                        <Link
                                            ...
                                            <div
                                                className="w-[8vw] h-[8vw] rounded-full bg-darkGreen flex justify-center items-center">
                                                <img
                                                    src={user.profileImageUrl || SignupIcon}
                                                    alt="User Icon"
