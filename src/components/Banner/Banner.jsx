...
const Banner = () => {
    return (
        <div className='flex flex-col md:flex-row justify-between gap-[4vw] xs:pt-[8vw] sm:gap-[2.5vw] md:gap-[2vw] items-center mx-[4vw] my-[8vw] pb-[6vw] pr-[3vw] sm:pt-[3vw] pl-[4vw] bg-lightGreen rounded-[3vw]'>
        <div>
            <h1
                data-aos="zoom-out"
        ...
        <div data-aos="zoom-in" className='mt-[5vw] lg:mt-0'>
            <img src={BannerImage} className='rounded-[2.5vw] sm:rounded-[2vw] md:rounded-[1.5vw] lg:rounded-[1.3vw] w-full lg:w-auto' alt='An image of different herbs' />
        </div>
    </div>
