...
const StoryBanner = () => {
    ...
    <div className='w-full md:w-1/2'>
        <img src={BannerImage} alt='An image of different herbs' className='w-full h-[30vw] md:w-[35vw] object-cover rounded-[1vw]'/>
    </div>
    <div className='w-full md:w-1/2 mt-[5vw] md:mt-0'>
        <h1 className='text-[5vw] text-center md:text-left md:text-[3vw] font-Lora font-bold leading-tight text-white'>
            Our Story
        </h1>
        <p className='mt-[2vw] text-[2.5vw] md:text-[1.3vw] text-white font-OpenSans'>
