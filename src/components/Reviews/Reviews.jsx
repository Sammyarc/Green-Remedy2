        ...
        <div className='px-[5vw] pt-[8vw] pb-[5vw] bg-darkGreen'>
            ...
            <div className='flex flex-col justify-center items-center'>
                <h1
                    ...
                    data-aos-delay="100"
                    className='font-Lora md:text-[2.5vw] text-white font-bold'>What Our Customers Say</h1>
                <p
                    data-aos="fade-up"
                    data-aos-duration="500"
                    data-aos-delay="200"
                    className='md:text-center md:w-[40vw] md:mt-[0.5vw] text-[1.2vw] text-white'>Read
                        ...
                        reviewItems.map((data) => (
                            <div
                                ...
                                <div className='px-[1.5vw] mt-[4vw]'>
                                    <p className='font-OpenSans text-[1.2vw] font-medium w-[20vw]'>{data.paragraph}</p>
                                    ...
                                    <div className='mt-[2vw] flex items-center gap-[1.5vw]'>
                                        ...
                                        <div>
                                            <p className='font-OpenSans text-[1.2vw] font-bold text-textColor'>{data.name}</p>
                                            <p className='font-OpenSans text-[0.9vw] font-bold text-textColor'>{data.title}</p>
                                        </div>
                                    </div>
                                </div>
