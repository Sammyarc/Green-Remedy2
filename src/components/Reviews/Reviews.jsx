...
const reviewItems = [
    {
        id: 1,
        image: Quotes,
        paragraph: "OHHHH Thank God !!!! Finally there is someone making it for me to use on my p" +
                "rojects. Love ya",
        ...
        data-aos-delay="100">
        {
            reviewItems.map((data) => (
                <div
                    ...
                    <img src={data.image} className="w-[5vw] sm:w-[3vw] md:w-[2vw] h-[5vw] sm:h-[3vw] md:h-[2vw]"></img>
                    <div className='px-[3vw] xs:px-[2.5vw] sm:px-[2vw] md:px-[1.5vw] mt-[6vw] xs:mt-[5vw] sm:mt-[4vw] md:mt-[2vw]'>
                        <p className='font-OpenSans text-[3.5vw] xs:text-[2.5vw] sm:text-[2vw] md:text-[1.2vw] font-medium w-full md:w-[20vw]'>{data.paragraph}</p>
                        <div className='flex items-center gap-[2vw] xs:gap-[1.5vw] sm:gap-[1vw] md:gap-[0.7vw] mt-[4vw] sm:mt-[3vw] md:mt-[2vw]'>
                        ...
                        <div className='mt-[4vw] xs:mt-[3vw] sm:mt-[2.5vw] md:mt-[2vw] flex items-center gap-[4vw] xs:gap-[3vw] sm:gap-[2vw] md:gap-[1.5vw]'>
                            <div className="w-[12vw] xs:w-[10vw] sm:w-[8vw] md:w-[5vw] h-[12vw] xs:h-[10vw] sm:h-[8vw] md:h-[5vw] rounded-full border-[0.8vw] xs:border-[0.5vw] sm:border-[0.4vw] md:border-[0.3vw] border-darkGreen">
                                <img src={data.review} className="w-full h-full object-cover rounded-full" />
                            </div>
                            <div>
                                <p className='font-OpenSans text-[3vw] xs:text-[2.5vw] sm:text-[1.8vw] md:text-[1.2vw] font-bold text-textColor'>{data.name}</p>
                                <p className='font-OpenSans text-[2.5vw] xs:text-[2vw] sm:text-[1.5vw] md:text-[0.9vw] font-bold text-textColor'>{data.title}</p>
                            </div>
                        </div>
                    </div>
                </div>
