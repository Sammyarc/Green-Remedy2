        ...
        <div
            ...
            <div className="w-full md:w-[30vw] mb-8 md:mb-0">
                ...
                <a
                    ...
                    data-aos-delay="200"
                    href="#"
                    className="bg-milkWhite text-lightTextColor mt-6 w-[50%] md:w-[12.5vw] h-[8vw] sm:h-[6vw] md:h-[4vw] text-[4vw] sm:text-[2.5vw] md:text-[1.1vw] flex justify-center items-center rounded-xl md:rounded-3xl font-bold">
                    Explore our herbs
                </a>
            </div>
            <div className="w-full md:w-[40vw]" data-aos="zoom-in" data-aos-once="true">
