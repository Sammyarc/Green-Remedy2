    ...
    return (
        <div
            ...
            <div className="w-full md:w-[30vw] mb-8 md:mb-0">
                ...
                <p
                    className="mt-4 text-[3.5vw] sm:text-[2vw] md:text-[1vw] text-milkWhite font-OpenSans">
                ...
                <a
                    href="#"
                    className="font-OpenSans bg-milkWhite text-lightTextColor mt-6 w-[35vw] md:w-[12.5vw] h-[8vw] sm:h-[6vw] md:h-[4vw] text-[3.5vw] sm:text-[2.5vw] md:text-[1.1vw] flex justify-center items-center rounded-xl md:rounded-3xl font-bold">
                    Explore our herbs
                </a>
            </div>
