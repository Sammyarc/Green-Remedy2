  ...
  return (
    <div>
      ...
      <main>
        <div className="flex flex-col md:flex-row border-t-2 border-gray-300 justify-between px-4 py-4 md:px-[5vw] md:py-[5vw]">
              ...
              cart.map((item, index) => (
                <div key={index} className="flex flex-col border-gray-200 mb-4 px-4 py-2">
                  <div className="flex justify-between items-center mb-1 space-x-1">
                    ...
                    <div className="flex items-center justify-between h-[10vw] w-[25vw] px-[2vw] bg-white border border-gray-300 rounded-full">
                      <FaMinus
                        onClick={() => handleDecrement(item.id, item.quantity)}
          ...
          <div className="w-full h-full md:w-1/4 bg-white shadow-lg rounded-lg mt-4 md:mt-0 md:ml-4">
            ...
            <div className="flex justify-between mb-2 p-4 border-b">
              ...
              <span className='text-[3.5vw] md:text-[1vw] font-OpenSans text-textColor'>₦0</span>
            </div>
            <div className="flex justify-between p-4 border-b">
              <span className='text-[3.5vw] md:text-[1vw] font-OpenSans text-textColor'>TOTAL</span>
              <span className='text-[3.5vw] md:text-[1vw] font-OpenSans text-textColor'>
                {`₦${calculateTotal().toLocaleString()}`}
              </span>
            </div>
            <div>
              <Link to="/checkout">
                <button
                  className={`w-full font-OpenSans text-[3.5vw] md:text-[1vw] py-[1vw] text-white rounded-b-lg 
                  ${isDisabled ? "bg-gray-400 cursor-not-allowed" : "bg-darkGreen"}`}
                  disabled={isDisabled}
                >
                  Proceed to Checkout
                </button>
        ...
        {/* Product Features and Similar Products */}
        <div>
          <Productsfeature />
          <SimilarProducts />
        </div>
