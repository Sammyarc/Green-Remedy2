                ...
                <div
                                    ...
                                    <div key={index} className="flex flex-col border-gray-200 mb-4 px-4 py-2">
                                        ...
                                        <div className="flex items-center justify-between mt-[5vw]">
                                            ...
                                            <div>
                                                <FaTimes
                                                    onClick={() => removeFromCart(item)}
                                                    className="text-textColor text-[6vw] font-OpenSans cursor-pointer"/>
                                            </div>
                                        </div>
                    ...
                    <div
                        ...
                        <div>
                            <Link to="/checkout">
                                <button
                                    className={`w-full font-OpenSans text-[3.5vw] py-[4vw] md:text-[1vw] md:py-[1vw] text-white rounded-b-lg 
                  ${isDisabled
